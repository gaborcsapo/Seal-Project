var Spiral = (function(parameter,window,d3){
    ...
    //it's for discarding outliers for the spiral graph. need to make dynamically settable in future
    var upperLimit;
    var lowerLimit;
    if (parameter == 'sal'){
      upperLimit = 34;
    ...
    function calcSpiral(){  
      return new Promise(function (resolve, reject) {
        ...
        //calculating the 4 vertices of trapezoids that represent one day on the spiral
        ...
        //calculating the position of ticks for months and the names of months
        ...
        //calculate position of year names
        ...
        //Scales for color and xy position
    ...
    function render(){
      return new Promise(function (resolve, reject) {
        ...
        //the actual data aka the little trapeziods representing each day and coloring them according to the data
        ...
        //black spiral line for reference
        ...
        //monthNames are put on this line
